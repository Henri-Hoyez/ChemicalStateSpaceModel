...
def h(x, _strength):
    deviation_from_linear = np.power(x+0.1, _strength)
    return deviation_from_linear
...
def main():
    ...
    strength = 1.1 +0.2*args.strength
    ...
    df_ssm_dataset.to_hdf(f"{args.save_path}/{strength:0.2f}.h5", key='data')
