...
from utils.utils import generate_inputs, generate_kfs, generate_outputs, generate_rhos, make_labels, make_dataset, make_folder, make_folder
import argparse
...
def main():
    ...
    shift_mean_1 = 3+ args.strength
    shift_mean_2 = 3+ args.strength
    ...
    df_ssm_dataset.to_hdf(f"{args.save_path}/{shift_mean_1}_{shift_mean_2}.h5", key='data')
